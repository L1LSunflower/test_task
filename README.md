...
>
> Рекомендую вам делать fork этого репозитория и делать коммиты в своем репозитории,
> чтобы я мог видеть ваш прогресс и помогать вам в случае возникновения вопросов
> и анализировать вашу работу в процессе выполнения. Такой формат так-же ускорит 
> процесс проверки вашего кода, так-как я смогу пропускать тот код который написал ранее я.
> 
